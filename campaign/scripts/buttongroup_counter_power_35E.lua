...
function onInit()
	...
	DB.addHandler(DB.getPath(node, "prepared"), "onUpdate", onValueChanged);
	DB.addHandler(DB.getPath(node, "cast"), "onUpdate", onValueChanged);
end
function onClose()
	local node = window.getDatabaseNode();
	DB.removeHandler(DB.getPath(node, "prepared"), "onUpdate", onValueChanged);
	DB.removeHandler(DB.getPath(node, "cast"), "onUpdate", onValueChanged);
end
