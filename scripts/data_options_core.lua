...
function onInit()
	OptionsManager.registerOption2("COLOR", true, "option_header_client", "option_label_COLOR", "option_entry_colorselect_user", {});
	...
	OptionsManager.registerOption2("CWHR", true, "option_header_client", "option_label_CWHR", "option_entry_cycler", 
			{ labels = "option_val_on", values = "on", baselabel = "option_val_off", baseval = "off", default = "on" });
	OptionsManager.registerOption2("WSAV", true, "option_header_client", "option_label_WSAV", "option_entry_cycler", 
			{ labels = "option_val_on", values = "on", baselabel = "option_val_off", baseval = "off", default = "off" });
	...
	OptionsManager.registerOption2("TBOX", false, "option_header_game", "option_label_TBOX", "option_entry_cycler", 
			{ labels = "option_val_on", values = "on", baselabel = "option_val_off", baseval = "off", default = "off" });
	OptionsManager.registerOption2("CLSH", false, "option_header_game", "option_label_CLSH", "option_entry_cycler", 
			{ labels = "option_val_active", values = "active", baselabel = "option_val_all", baseval = "all", default = "all" });
	...
	OptionsManager.registerOption2("TFOW", false, "option_header_token", "option_label_TFOW", "option_entry_cycler", 
			{ labels = "option_val_on|option_val_pc", values = "on|pc", baselabel = "option_val_off", baseval = "off", default = "pc" });

	OptionsManager.registerOption2("HRDD", false, "option_header_houserule", "option_label_HRDD", "option_entry_cycler", 
			{ labels = "option_val_x1|option_val_x1_5|option_val_raw", values = "x1|variant|raw", baselabel = "option_val_default", baseval = "", default = "" });
