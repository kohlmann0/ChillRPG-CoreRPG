...
function onTabletopInit()
	if Session.IsHost then
		Comm.registerSlashHandler("gmid", GmIdentityManager.slashCommandHandlerGmId, "[name]");
		Comm.registerSlashHandler("id", GmIdentityManager.slashCommandHandlerId, "[name]");
	end
